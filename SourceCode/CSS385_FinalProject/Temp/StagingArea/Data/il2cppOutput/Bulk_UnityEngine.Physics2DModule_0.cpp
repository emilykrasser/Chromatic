...
extern "C" IL2CPP_METHOD_ATTR Vector2_t2156229523  Rigidbody2D_get_position_m2575647076 (Rigidbody2D_t939494601 * __this, const RuntimeMethod* method)
{
	...
	memset(&V_0, 0, sizeof(V_0));
	{
		Rigidbody2D_get_position_Injected_m2554601898(__this, (&V_0), /*hidden argument*/NULL);
...
{
	{
		Rigidbody2D_MovePosition_Injected_m2788255147(__this, (&___position0), /*hidden argument*/NULL);
		return;
	}
}
